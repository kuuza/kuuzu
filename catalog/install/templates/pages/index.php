...
$configfile_array = [
    KUUZU::BASE_DIR . 'Conf/global.php',
    KUUZU::BASE_DIR . 'Sites/Shop/site_conf.php',
    KUUZU::BASE_DIR . 'Sites/Admin/site_conf.php'
];
...
<div class="alert alert-info">
  <h2>Welcome to Kuuzu <small>v<?php echo KUUZU::getVersion(); ?></small></h2>

  <p>Kuuzu helps you sell products worldwide with your own online store. Its Administration Dashboard manages products, customers, orders, newsletters, specials, and more to successfully build the success of your online business.</p>
  <p>Kuuzu has attracted a large community of store owners and developers who support each other and have provided add-ons that can extend the features and potential of your online store.</p>
</div>

<div class="alert alert-warning">
  <h2>Beta Release</h2>

  <p>This release is currently a beta release recommended only for development and testing purposes. Please visit the <a href="https://kuuzu.org" target="_blank" class="alert-link">Kuuzu</a> website to stay up to date on production-ready releases.</p>
</div>
