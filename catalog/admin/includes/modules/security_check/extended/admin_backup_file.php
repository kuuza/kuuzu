  ...
  */
  ...
  class securityCheckExtended_admin_backup_file {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_security_check_extended_admin_backup_file_title');
    }
    ...
    function pass() {
      ...
      if ( isset($backup_file) ) {
        $request = $this->getHttpRequest(KUUZU::link('includes/backups/' . $backup_file));
    ...
    function getMessage() {
      return KUUZU::getDef('module_security_check_extended_admin_backup_file_http_200', [
