  ...
  */
  ...
  class d_total_revenue {
    ...
    function d_total_revenue() {
      $this->title = KUUZU::getDef('module_admin_dashboard_total_revenue_title');
      $this->description = KUUZU::getDef('module_admin_dashboard_total_revenue_description');
    ...
    function getOutput() {
      ...
      $Qorders = $KUUZU_Db->query('select date_format(o.date_purchased, "%Y-%m-%d") as dateday, sum(ot.value) as total from :table_orders o, :table_orders_total ot where date_sub(curdate(), interval 7 day) <= o.date_purchased and o.orders_id = ot.orders_id and ot.class = "ot_total" group by dateday');
      ...
      $chart_label = HTML::output(KUUZU::getDef('module_admin_dashboard_total_revenue_chart_link'));
      $chart_label_link = KUUZU::link(FILENAME_ORDERS);
