...
<link rel="stylesheet" type="text/css" href="<?= KUUZU::linkPublic('Templates/Sail/css/stylesheet.css'); ?>">
</head>
<body>
...
<table border="0" width="100%" cellspacing="0" cellpadding="2">
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td class="pageHeading" align="right"><?php echo HTML::image(KUUZU::linkImage('Shop/' . STORE_LOGO), STORE_NAME); ?></td>
      </tr>
    </table></td>
  </tr>
  <tr>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><strong><?php echo KUUZU::getDef('entry_sold_to'); ?></strong></td>
          </tr>
          <tr>
        ...
        <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2">
          <tr>
            <td class="main"><strong><?php echo KUUZU::getDef('entry_ship_to'); ?></strong></td>
          </tr>
          <tr>
  ...
  <tr>
    <td><table border="0" cellspacing="0" cellpadding="2">
      <tr>
        <td class="main"><strong><?php echo KUUZU::getDef('entry_payment_method'); ?></strong></td>
  ...
  <tr>
    <td><table border="0" width="100%" cellspacing="0" cellpadding="2">
      <tr class="dataTableHeadingRow">
        <td class="dataTableHeadingContent" colspan="2"><?php echo KUUZU::getDef('table_heading_products'); ?></td>
        <td class="dataTableHeadingContent"><?php echo KUUZU::getDef('table_heading_products_model'); ?></td>
        <td class="dataTableHeadingContent" align="right"><?php echo KUUZU::getDef('table_heading_tax'); ?></td>
        <td class="dataTableHeadingContent" align="right"><?php echo KUUZU::getDef('table_heading_price_excluding_tax'); ?></td>
        <td class="dataTableHeadingContent" align="right"><?php echo KUUZU::getDef('table_heading_price_including_tax'); ?></td>
        <td class="dataTableHeadingContent" align="right"><?php echo KUUZU::getDef('table_heading_total_excluding_tax'); ?></td>
        <td class="dataTableHeadingContent" align="right"><?php echo KUUZU::getDef('table_heading_total_including_tax'); ?></td>
      </tr>
<?php
