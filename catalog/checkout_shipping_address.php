...
// if there is nothing in the customers cart, redirect them to the shopping cart page
  ...
  $KUUZU_Language->loadDefinitions('checkout_shipping_address');
...
// process a new shipping address
    if (tep_not_null($_POST['firstname']) && tep_not_null($_POST['lastname']) && tep_not_null($_POST['street_address'])) {
      ...
      if ($error == false) {
        ...
        $_SESSION['sendto'] = $KUUZU_Db->lastInsertId();
...
// if no shipping destination address was selected, use their own address as default
  ...
  $breadcrumb->add(KUUZU::getDef('navbar_title_2'), KUUZU::link('checkout_shipping_address.php'));
...
<?php echo HTML::form('checkout_address', KUUZU::link('checkout_shipping_address.php'), 'post', 'class="form-horizontal"', ['tokenize' => true]); ?>
...
?>
  ...
  <h2><?php echo KUUZU::getDef('table_heading_shipping_address'); ?></h2>

  <div class="contentText row">
    <div class="col-sm-8">
      <div class="alert alert-warning"><?php echo KUUZU::getDef('text_selected_shipping_destination'); ?></div>
    </div>
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading"><?php echo KUUZU::getDef('title_shipping_address'); ?></div>
...
?>
  ...
  <div class="alert alert-info"><?php echo KUUZU::getDef('text_select_other_shipping_destination'); ?></div>
...
?>
  ...
  <h2><?php echo KUUZU::getDef('table_heading_new_shipping_address'); ?></h2>

  <div class="alert alert-info"><?php echo KUUZU::getDef('text_create_new_shipping_address'); ?></div>
...
?>
  ...
  <div class="buttonSet">
    <?php echo HTML::button(KUUZU::getDef('image_button_back'), 'fa fa-angle-left', KUUZU::link('checkout_shipping_address.php')); ?>
  </div>
