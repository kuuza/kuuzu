...
// load the selected payment module
  ...
  if (strpos($payment_modules->selected_module, '\\') !== false) {
    ...
    $KUUZU_PM = $GLOBALS[$_SESSION['payment']];
  }

  if ( !isset($KUUZU_PM) || ($payment_modules->selected_module != $_SESSION['payment']) || ($KUUZU_PM->enabled == false) ) {
...
<?php
  ...
  if (isset($KUUZU_PM->form_action_url)) {
    $form_action_url = $KUUZU_PM->form_action_url;
  } else {
    $form_action_url = KUUZU::link('checkout_process.php');
  }
...
<div class="contentContainer">
  <div class="contentText">
    ...
    <div class="panel panel-default">
      <div class="panel-heading"><?php echo '<strong>' . KUUZU::getDef('heading_products') . '</strong>' . HTML::button(KUUZU::getDef('text_edit'), 'fa fa-edit', KUUZU::link('shopping_cart.php'), null, 'pull-right btn-info btn-xs' ); ?></div>
  ...
  <div class="row">
    ...
    if ($_SESSION['sendto'] != false) {
      ...
      <div class="col-sm-4">
        <div class="panel panel-info">
          <div class="panel-heading"><?php echo '<strong>' . KUUZU::getDef('heading_delivery_address') . '</strong>' . HTML::button(KUUZU::getDef('text_edit'), 'fa fa-edit', KUUZU::link('checkout_shipping_address.php'), null, 'pull-right btn-info btn-xs' ); ?></div>
          <div class="panel-body">
    ...
    <div class="col-sm-4">
      <div class="panel panel-warning">
        <div class="panel-heading"><?php echo '<strong>' . KUUZU::getDef('heading_billing_address') . '</strong>' . HTML::button(KUUZU::getDef('text_edit'), 'fa fa-edit', KUUZU::link('checkout_payment_address.php'), null, 'pull-right btn-info btn-xs' ); ?></div>
        <div class="panel-body">
    ...
    <div class="col-sm-4">
      ...
      if ($order->info['shipping_method']) {
        ?>
        <div class="panel panel-info">
          <div class="panel-heading"><?php echo '<strong>' . KUUZU::getDef('heading_shipping_method') . '</strong>' . HTML::button(KUUZU::getDef('text_edit'), 'fa fa-edit', KUUZU::link('checkout_shipping.php'), null, 'pull-right btn-info btn-xs' ); ?></div>
          <div class="panel-body">
      ...
      ?>
      <div class="panel panel-warning">
        <div class="panel-heading"><?php echo '<strong>' . KUUZU::getDef('heading_payment_method') . '</strong>' . HTML::button(KUUZU::getDef('text_edit'), 'fa fa-edit', KUUZU::link('checkout_payment.php'), null, 'pull-right btn-info btn-xs' ); ?></div>
        <div class="panel-body">
...
?>
  ...
  <h2><?php echo KUUZU::getDef('heading_payment_information'); ?></h2>
...
?>
  ...
  <h2><?php echo '<strong>' . KUUZU::getDef('heading_order_comments') . '</strong> ' . HTML::button(KUUZU::getDef('text_edit'), 'fa fa-edit', KUUZU::link('checkout_payment.php'), null, 'pull-right btn-info btn-xs' ); ?></h2>
...
?>
  ...
  <div class="buttonSet">
    <div class="text-right">
      ...
      echo HTML::button(KUUZU::getDef('image_button_pay_total_now', ['total' => $currencies->format($order->info['total'], true, $order->info['currency'], $order->info['currency_value'])]), 'fa fa-ok', null, array('params' => 'data-button="payNow"'), 'btn-success');
      ?>
    </div>
  </div>
  ...
  <div class="contentText">
    <div class="stepwizard">
      <div class="stepwizard-row">
        ...
        <div class="stepwizard-step">
          <a href="<?php echo KUUZU::link('checkout_payment.php'); ?>"><button type="button" class="btn btn-default btn-circle">2</button></a>
          <p><a href="<?php echo KUUZU::link('checkout_payment.php'); ?>"><?php echo KUUZU::getDef('checkout_bar_payment'); ?></a></p>
        </div>
        <div class="stepwizard-step">
...
$('form[name="checkout_confirmation"]').submit(function() {
  $('form[name="checkout_confirmation"] button[data-button="payNow"]').html('<?php echo addslashes(KUUZU::getDef('image_button_pay_total_processing')); ?>').prop('disabled', true);
});
</script>
