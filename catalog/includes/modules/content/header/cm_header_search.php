  ...
  */
  ...
  class cm_header_search {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_header_search_title');
      $this->description = KUUZU::getDef('module_content_header_search_description');
    ...
    function execute() {
      ...
      $search_box .= HTML::form('quick_find', KUUZU::link('advanced_search_result.php', '', false), 'get', 'class="form-horizontal"', ['session_id' => true]);
      $search_box .= '  <div class="input-group">' .
                          HTML::inputField('keywords', '', 'required placeholder="' . KUUZU::getDef('text_search_placeholder') . '"', 'search') . '<span class="input-group-btn"><button type="submit" class="btn btn-info"><i class="fa fa-search"></i></button></span>' .
                     '  </div>';
      $search_box .= '</form>';
      $search_box .= '</div>';
