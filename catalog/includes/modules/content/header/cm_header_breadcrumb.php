  ...
  */
  ...
  class cm_header_breadcrumb {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_header_breadcrumb_title');
      $this->description = KUUZU::getDef('module_content_header_breadcrumb_description');
