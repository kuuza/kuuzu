  ...
  */
  ...
  class cm_account_sage_pay_cards {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_account_sage_pay_cards_title');
      $this->description = KUUZU::getDef('module_content_account_sage_pay_cards_description');
      ...
      $this->public_title = KUUZU::getDef('module_content_account_sage_pay_cards_link_title');
      ...
      if ( defined('MODULE_PAYMENT_INSTALLED') && tep_not_null(MODULE_PAYMENT_INSTALLED) && in_array('sage_pay_direct.php', explode(';', MODULE_PAYMENT_INSTALLED)) ) {
        if ( !class_exists('sage_pay_direct') ) {
          ...
          include(KUUZU::getConfig('dir_root', 'Shop') . 'includes/modules/payment/sage_pay_direct.php');
        }
      ...
      if ( $sage_pay_enabled !== true ) {
        ...
        $this->description = '<div class="secWarning">' . KUUZU::getDef('module_content_account_sage_pay_cards_error_main_module') . '</div>' . $this->description;
      }
    }
    ...
    function execute() {
      ...
      $kuuTemplate->_data['account']['account']['links']['sage_pay_cards'] = array('title' => $this->public_title,
                                                                                   'link' => KUUZU::link('ext/modules/content/account/sage_pay/cards.php'),
                                                                                   'icon' => 'newwin');
    }
