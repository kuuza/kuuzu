  ...
  */
  ...
  class cm_footer_account {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_footer_account_title');
      $this->description = KUUZU::getDef('module_content_footer_account_description');
    ...
    function execute() {
      ...
      if ( isset($_SESSION['customer_id']) ) {
        $account_content = '<li><a href="' . KUUZU::link('account.php') . '">' . KUUZU::getDef('module_content_footer_account_box_account') . '</a></li>' .
                           '<li><a href="' . KUUZU::link('address_book.php') . '">' . KUUZU::getDef('module_content_footer_account_box_address_book') . '</a></li>' .
                           '<li><a href="' . KUUZU::link('account_history.php') . '">' . KUUZU::getDef('module_content_footer_account_box_order_history') . '</a></li>' .
                           '<li><br><a class="btn btn-danger btn-sm btn-block" role="button" href="' . KUUZU::link('logoff.php') . '"><i class="fa fa-sign-out"></i> ' . KUUZU::getDef('module_content_footer_account_box_logoff') . '</a></li>';
      }
      else {
        $account_content = '<li><a href="' . KUUZU::link('create_account.php') . '">' . KUUZU::getDef('module_content_footer_account_box_create_account') . '</a></li>' .
                           '<li><br><a class="btn btn-success btn-sm btn-block" role="button" href="' . KUUZU::link('login.php') . '"><i class="fa fa-sign-in"></i> ' . KUUZU::getDef('module_content_footer_account_box_login') . '</a></li>';
      }
