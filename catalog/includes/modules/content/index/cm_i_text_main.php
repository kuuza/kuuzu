  ...
  */
  ...
  class cm_i_text_main {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_text_main_title');
      $this->description = KUUZU::getDef('module_content_text_main_description');
    ...
    function execute() {
      ...
      if (tep_not_null(KUUZU::getDef('module_content_text_main_text'))) {
        ob_start();
