  ...
  */
  ...
  class cm_i_new_products {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_new_products_title');
      $this->description = KUUZU::getDef('module_content_new_products_description');
    ...
    function execute() {
      global $kuuTemplate, $new_products_category_id, $currencies, $PHP_SELF;
      ...
      $Qproducts = $KUUZU_Db->prepare($sql);
