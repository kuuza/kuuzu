  ...
  */
  ...
  class cm_i_customer_greeting {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_customer_greeting_title');
      $this->description = KUUZU::getDef('module_content_customer_greeting_description');
    ...
    function execute() {
      ...
      if (isset($_SESSION['customer_id'])) {
        $customer_greeting = KUUZU::getDef('module_content_customer_greeting_personal', ['customer_first_name' => HTML::outputProtected($_SESSION['customer_first_name']), 'products_new_link' => KUUZU::link('products_new.php')]);
      } else {
        $customer_greeting = KUUZU::getDef('module_content_customer_greeting_guest', ['guest_login_link' => KUUZU::link('login.php'), 'guest_create_account_link' =>  KUUZU::link('create_account.php')]);
      }
