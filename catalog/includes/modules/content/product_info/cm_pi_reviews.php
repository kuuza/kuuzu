  ...
  */
  ...
  class cm_pi_reviews {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_product_info_reviews_title');
      $this->description = KUUZU::getDef('module_content_product_info_reviews_description');
      ...
      if ($Qreviews->fetch() !== false) {
        ...
        do {
          $review_data .= '<blockquote class="col-sm-6">' .
                          ...
                          '  <footer>' . KUUZU::getDef('module_content_product_info_reviews_text_rated', ['reviews_rating' => HTML::stars($Qreviews->valueInt('reviews_rating')), 'customers_name' => $Qreviews->valueProtected('customers_name')]) . '</footer>' .
                          '</blockquote>';
