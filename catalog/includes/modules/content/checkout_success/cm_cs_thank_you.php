  ...
  */
  ...
  class cm_cs_thank_you {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_content_checkout_success_thank_you_title');
      $this->description = KUUZU::getDef('module_content_checkout_success_thank_you_description');
