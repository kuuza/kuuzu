  ...
  */
  ...
  class bm_shopping_cart {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_boxes_shopping_cart_title');
      $this->description = KUUZU::getDef('module_boxes_shopping_cart_description');
    ...
    function execute() {
      global $new_products_id_in_cart, $currencies, $kuuTemplate;
      ...
      if ($_SESSION['cart']->count_contents() > 0) {
        ...
        for ($i=0, $n=sizeof($products); $i<$n; $i++) {
          ...
          $cart_contents_string .= '<a href="' . KUUZU::link('product_info.php', 'products_id=' . $products[$i]['id']) . '">';
        ...
        $cart_contents_string .= '<p>' . KUUZU::getDef('module_boxes_shopping_cart_box_cart_empty') . '</p>';
      }
