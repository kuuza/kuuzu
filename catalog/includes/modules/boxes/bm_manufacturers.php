  ...
  */
  ...
  class bm_manufacturers {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_boxes_manufacturers_title');
      $this->description = KUUZU::getDef('module_boxes_manufacturers_description');
    ...
    function getData() {
      ...
      $Qmanufacturers = $KUUZU_Db->prepare('select manufacturers_id, manufacturers_name from :table_manufacturers order by manufacturers_name');
...
// Display a list
          ...
          foreach ($manufacturers as $m) {
            ...
            $manufacturers_list .= '<li><a href="' . KUUZU::link('index.php', 'manufacturers_id=' . (int)$m['manufacturers_id']) . '">' . $manufacturers_name . '</a></li>';
          }
...
// Display a drop-down
          ...
          if (MAX_MANUFACTURERS_LIST < 2) {
            $manufacturers_array[] = array('id' => '', 'text' => KUUZU::getDef('pull_down_default'));
          }
          ...
          $data = HTML::form('manufacturers', KUUZU::link('index.php', '', false), 'get', null, ['session_id' => true]) .
