  ...
  */
  ...
  class bm_whats_new {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_boxes_whats_new_title');
      $this->description = KUUZU::getDef('module_boxes_whats_new_description');
    ...
    function execute() {
      ...
      $Qcheck = $KUUZU_Db->query('select products_id, products_image, products_tax_class_id, products_price from :table_products where products_status = 1 order by products_date_added desc limit ' . (int)MAX_RANDOM_SELECT_NEW);
