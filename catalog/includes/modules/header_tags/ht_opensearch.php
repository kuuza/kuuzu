  ...
  */
  ...
  class ht_opensearch {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_header_tags_opensearch_title');
      $this->description = KUUZU::getDef('module_header_tags_opensearch_description');
    ...
    function execute() {
      ...
      $kuuTemplate->addBlock('<link rel="search" type="application/opensearchdescription+xml" href="' . KUUZU::link('opensearch.php', '', false) . '" title="' . HTML::output(STORE_NAME) . '" />', $this->group);
    }
    ...
    function install() {
      ...
      $KUUZU_Db->save('configuration', [
        ...
        'configuration_value' => KUUZU::linkImage('Shop/favicon.ico'),
