  ...
  */
  ...
  class ht_robot_noindex {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_header_tags_robot_noindex_title');
      $this->description = KUUZU::getDef('module_header_tags_robot_noindex_description');
    ...
    function execute() {
      ...
      if (tep_not_null(MODULE_HEADER_TAGS_ROBOT_NOINDEX_PAGES)) {
        ...
        if (in_array(basename($PHP_SELF), $pages_array)) {
          $kuuTemplate->addBlock('<meta name="robots" content="noindex,follow" />' . "\n", $this->group);
        }
      }
    }
