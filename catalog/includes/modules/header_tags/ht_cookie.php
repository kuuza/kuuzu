  ...
  */
  ...
  class ht_cookie {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_header_tags_cookie_title');
      $this->description = KUUZU::getDef('module_header_tags_cookie_description');
    ...
    function execute() {
      ...
      $message = KUUZU::getDef('module_header_tags_cookie_message_text');
      $dismiss = KUUZU::getDef('module_header_tags_cookie_dismiss_text');
      $more    = KUUZU::getDef('module_header_tags_cookie_more_text');
      $link    = KUUZU::link(MODULE_HEADER_TAGS_COOKIE_PAGE);
      $theme   = KUUZU::link('ext/cookieconsent2/' . MODULE_HEADER_TAGS_COOKIE_THEME . '.css', null, false);

      $script_src = KUUZU::link('ext/cookieconsent2/cookieconsent.min.js', null, false);
