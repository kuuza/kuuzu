  ...
  */
  ...
  class ht_grid_list_view {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_header_tags_grid_list_view_title');
      $this->description = KUUZU::getDef('module_header_tags_grid_list_view_description');
