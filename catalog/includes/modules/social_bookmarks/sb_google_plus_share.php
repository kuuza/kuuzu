  ...
  */
  ...
  class sb_google_plus_share {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_social_bookmarks_google_plus_share_title');
      $this->public_title = KUUZU::getDef('module_social_bookmarks_google_plus_share_public_title');
      $this->description = KUUZU::getDef('module_social_bookmarks_google_plus_share_description');
    ...
    function getOutput() {
      ...
      $output = '<div class="g-plus" data-action="share" data-href="' . KUUZU::link('product_info.php', 'products_id=' . $_GET['products_id'], false) . '" data-annotation="' . strtolower(MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_SHARE_ANNOTATION) . '"';
