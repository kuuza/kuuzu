  ...
  */
  ...
  class sb_digg {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_social_bookmarks_digg_title');
      $this->public_title = KUUZU::getDef('module_social_bookmarks_digg_public_title');
      $this->description = KUUZU::getDef('module_social_bookmarks_digg_description');
    ...
    function getOutput() {
      return '<a href="http://digg.com/submit?url=' . urlencode(KUUZU::link('product_info.php', 'products_id=' . $_GET['products_id'], false)) . '" target="_blank"><img src="' . KUUZU::linkImage('social_bookmarks/' . $this->icon) . '" border="0" title="' . HTML::outputProtected($this->public_title) . '" alt="' . HTML::outputProtected($this->public_title) . '"/></a>';
    }
