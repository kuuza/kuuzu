  ...
  */
  ...
  class sb_facebook_like {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_social_bookmarks_facebook_like_title');
      $this->public_title = KUUZU::getDef('module_social_bookmarks_facebook_like_public_title');
      $this->description = KUUZU::getDef('module_social_bookmarks_facebook_like_description');
