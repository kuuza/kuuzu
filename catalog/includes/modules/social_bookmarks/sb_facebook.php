  ...
  */
  ...
  class sb_facebook {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_social_bookmarks_facebook_title');
      $this->public_title = KUUZU::getDef('module_social_bookmarks_facebook_public_title');
      $this->description = KUUZU::getDef('module_social_bookmarks_facebook_description');
    ...
    function getOutput() {
      return '<a href="http://www.facebook.com/share.php?u=' . urlencode(KUUZU::link('product_info.php', 'products_id=' . $_GET['products_id'], false)) . '" target="_blank"><img src="' . KUUZU::linkImage('social_bookmarks/' . $this->icon) . '" border="0" title="' . HTML::outputProtected($this->public_title) . '" alt="' . HTML::outputProtected($this->public_title) . '" /></a>';
    }
