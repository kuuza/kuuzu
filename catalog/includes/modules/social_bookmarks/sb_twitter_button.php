  ...
  */
  ...
  class sb_twitter_button {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_social_bookmarks_twitter_button_title');
      $this->public_title = KUUZU::getDef('module_social_bookmarks_twitter_button_public_title');
      $this->description = KUUZU::getDef('module_social_bookmarks_twitter_button_description');
    ...
    function getOutput() {
      $params = array('url=' . urlencode(KUUZU::link('product_info.php', 'products_id=' . $_GET['products_id'], false)));
