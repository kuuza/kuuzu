  ...
  */
  ...
  class sb_email {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_social_bookmarks_email_title');
      $this->public_title = KUUZU::getDef('module_social_bookmarks_email_public_title');
      $this->description = KUUZU::getDef('module_social_bookmarks_email_description');
    ...
    function getOutput() {
      return '<a href="' . KUUZU::link('tell_a_friend.php', 'products_id=' . $_GET['products_id']) . '"><img src="' . KUUZU::linkImage('social_bookmarks/' . $this->icon) . '" border="0" title="' . HTML::outputProtected($this->public_title) . '" alt="' . HTML::outputProtected($this->public_title) . '" /></a>';
    }
