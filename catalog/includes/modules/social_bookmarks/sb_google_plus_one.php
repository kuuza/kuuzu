  ...
  */
  ...
  class sb_google_plus_one {
    ...
    function __construct() {
      ...
      $this->title = KUUZU::getDef('module_social_bookmarks_google_plus_one_title');
      $this->public_title = KUUZU::getDef('module_social_bookmarks_google_plus_one_public_title');
      $this->description = KUUZU::getDef('module_social_bookmarks_google_plus_one_description');
    ...
    function getOutput() {
      $output = '<div class="g-plusone" data-href="' . KUUZU::link('product_info.php', 'products_id=' . $_GET['products_id'], false) . '" data-size="' . strtolower(MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_ONE_SIZE) . '" data-annotation="' . strtolower(MODULE_SOCIAL_BOOKMARKS_GOOGLE_PLUS_ONE_ANNOTATION) . '"';
