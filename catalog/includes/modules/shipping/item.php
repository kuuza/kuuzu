...
// class constructor
    function __construct() {
      ...
      $this->code = 'item';
      $this->title = KUUZU::getDef('module_shipping_item_text_title');
      $this->description = KUUZU::getDef('module_shipping_item_text_description');
      ...
      if ( ($this->enabled == true) && ((int)MODULE_SHIPPING_ITEM_ZONE > 0) ) {
        $check_flag = false;
        $Qcheck = $KUUZU_Db->get('zones_to_geo_zones', 'zone_id', ['geo_zone_id' => MODULE_SHIPPING_ITEM_ZONE, 'zone_country_id' => $order->delivery['country']['id']], 'zone_id');
        while ($Qcheck->fetch()) {
...
// class methods
    function quote($method = '') {
      ...
      $this->quotes = array('id' => $this->code,
                            'module' => KUUZU::getDef('module_shipping_item_text_title'),
                            'methods' => array(array('id' => $this->code,
                                                     'title' => KUUZU::getDef('module_shipping_item_text_way'),
