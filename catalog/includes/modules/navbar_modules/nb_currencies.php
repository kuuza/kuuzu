  ...
  */
  ...
  class nb_currencies {
    ...
    function __construct() {
      $this->title = KUUZU::getDef('module_navbar_currencies_title');
      $this->description = KUUZU::getDef('module_navbar_currencies_description');
    ...
    function getOutput() {
      global $kuuTemplate, $currencies, $PHP_SELF;
