...
?>
        ...
        <li><a><i class="fa fa-question-circle"></i></a>
          <ul class="dropdown-menu">
            <li><a href="<?= KUUZU::link('Shop/'); ?>" target="_blank">View Store</a></li>
            <li class="divider"></li>
            <li><a href="https://kuuzu.org">Kuuzu Website</a></li>
            <li><a href="https://kuuzu.org/forum">Help and Support</a></li>
            <li><a href="https://kuuzu.org/docs">Documentation</a></li>
            <li><a href="https://kuuzu.org/forum">Community Forum</a></li>
          </ul>
        </li>
      </ul>
    </div>
