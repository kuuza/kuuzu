  ...
  */
  ...
  class actionRecorder {
    ...
    function record($success = true) {
      ...
      if (tep_not_null($this->_module)) {
        $KUUZU_Db->save('action_recorder', ['module' => $this->_module, 'user_id' => (int)$this->_user_id, 'user_name' => $this->_user_name, 'identifier' => $this->getIdentifier(), 'success' => ($success == true ? 1 : 0), 'date_added' => 'now()']);
      }
    }
